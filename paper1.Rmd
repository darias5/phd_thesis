...
fun_create_map_helper <- function(data){
  ...
  data_temp %>%
    ...
    geom_sf(color = col_grey_dark, linewidth = 0.25) +
...
lower_block_3_1 <-  fun_lower_block(country = "all",
                                    label = "West \nAfrica",
                                    17.55830898122733, -25.766648641326874,
                                    9.591111921718683, -7.308676054124459,
