...
In addition to our base-case economic valuation, we further report our \acr{VSL} estimates using three times \acr{GDP} per capita as the value of a DALY. (Alternative valuations using values of $1,000 and $5,000, as well as \acr{PPP}-adjusted \acr{GDP} per capita, are reported in Tables S1.5 and S1.6 of Appendix 1.)
