...
#   tab_options(table.font.names = "Source Sans Pro",  page.header.use_tbl_headings	= TRUE) %>%
#   tab_style(
...
```{r table_s_2_6, echo = FALSE, include = TRUE, out.width = '97%'}

knitr::include_graphics("table_s_2_6.png")
...
```{r table_s_2_7, echo = FALSE, include = TRUE, out.width = '97%'}

knitr::include_graphics("table_s_2_7.png")
...
```{r table_s_2_8, echo = FALSE, include = TRUE, out.height = '97%'}

knitr::include_graphics("table_s_2_8.png")
...
```{r table_s_2_9a, echo = FALSE, include = TRUE, out.width = '97%'}

knitr::include_graphics("table_s_2_9a.png")

```


```{r table_s_2_9b, echo = FALSE, include = TRUE, out.width = '97%'}

knitr::include_graphics("table_s_2_9b.png")
...
In total, matching to our expanded inventory in Step 2 resulted in `r format(as.numeric(n_matched_facilities_step_2), big.mark = ",")` facilities (`r round(as.numeric(n_matched_facilities_step_2)/n_facilities_new * 100,0)`% of our sample) being geolocated.
...
Altogether, matching to centroids of communes and *fokontany* in Step 5 resulted in `r format(as.numeric(n_matched_facilities_step_5), big.mark = ",")` facilities (`r round(as.numeric(n_matched_facilities_step_5)/n_facilities_new * 100,0)`% of our sample) being geolocated.
...
Combined with the previous steps, targeted searches resulted in `r format(as.numeric(n_matched_facilities_step_6), big.mark = ",")` facilities (`r round(as.numeric(n_matched_facilities_step_6)/n_facilities_new * 100,1)`% of our sample) being geolocated.
