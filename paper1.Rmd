...
```{r table1_2, echo = FALSE, include = TRUE, out.width = '100%'}
...
Under the three approaches, we calculated the economic value of mental disorder losses (Table 3). `r results_sentence2`. Further adjusting for purchasing power parity, the global value of mental illness losses would exceed 7.2 trillion international dollars in 2019 (Table S7).
