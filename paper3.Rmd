...
paper3_abstract <- paste0("For searches related to depression, we observe a statistically significant slope change of ",
                          function_dynamic_text_results("main","depression", "slope"), " and a level shift of ",
                          function_dynamic_text_results("main","depression", "intercept"),
                          ", above and beyond changes in slope and level observed for searches for headaches. For anxiety, we observe a similar slope change decline of",
                          function_dynamic_text_results("main","anxiety", "slope"), 
                          " and a level shift of ",
                          function_dynamic_text_results("main","anxiety", "intercept"),
 ". We do not observe significant variation of estimates across predominately Democrat or Republican voting states and counties, and our results are robust to alternative specifications of bandwidth, fixed effects, and data cleaning decisions.")
...
## Introduction
The coronavirus disease 2019 (COVID-19) pandemic has had a profound effect on the mental health and wellbeing of individuals worldwide. In the United States, approximately four in ten adults reported experiencing symptoms of anxiety or depression in December 2020—a four-fold increase from January-June 2019.[@panchalImplicationsCOVID19Mental2021, p. 19] Studies from Australia,[@batterhamTrajectoriesDepressionAnxiety2021] China,[@ahmedEpidemicCOVID19China2020; @gaoMentalHealthProblems2020; @hwangLonelinessSocialIsolation; @leiComparisonPrevalenceAssociated2020; @liuPrevalencePredictorsPTSS2020; @qiuNationwideSurveyPsychological2020; @wangImmediatePsychologicalResponses2020; @wangStudyPublicPsychological2021; @wangPsychologicalDistressCoping2020; @zhangImpactCOVID19Pandemic2020] Denmark,[@sonderskovDepressiveStateDenmark] Europe,[@hajekPrevalenceDeterminantsProbable2022] Iran,[@moghanibashi-mansouriehAssessingAnxietyLevel2020] Ireland,[@hylandAnxietyDepressionRepublic2020]  Italy,[@mazzaNationwideSurveyPsychological2020; @mocciaAffectiveTemperamentAttachment2020] Nepal,[@samadarshiOnlineSurveyFactors2020] New Zealand,[@gasteigerDepressionAnxietyStress2021] Spain,[@gonzalez-sanguinoMentalHealthConsequences2020; @ozamiz-etxebarriaStressAnxietyDepression2020] Turkey[@ozdinLevelsPredictorsAnxiety2020],  the United States,[@jiaNationalStateTrends2021, p. 2020–2021; @kujawaExposureCOVID19Pandemic2020] and the United Kingdom[@dettmannInvestigatingPrevalenceAnxiety2022] report high levels of anxiety (6-51%), depression (15-48%), and post-traumatic stress disorder (7-54%) associated with aspects of the pandemic.  Globally, it is estimated that the prevalence of depression during the COVID-19 pandemic may be as high as 24%, with the prevalence of anxiety estimated at 21.3%.[@banko-ferranImpactCOVID19Mental2020; @castaldelli-maiaInvestigatingEffectNational2021] This striking burden has been described as a mental health crisis[@melimopoulosHowCOVID19Pandemic2021] and a pandemic in its own right.[@kwaiWhatPointYoung2021] 

While COVID-19 continues to bring unprecedented challenges to individuals and societies around the world, the development and distribution of safe and effective vaccines against COVID-19 has fundamentally changed the trajectory of the pandemic. Beyond the physical benefits vaccines provide in reducing the risk of infection and associated morbidity and mortality, a growing body of evidence suggests that vaccination has also contributed to improved mental health.[@agrawalImpactCOVID19Vaccine2021; @chourpiliadisShorttermImprovementMental2023; @nguyenPsychologicalBenefitsCOVID192021; @rubinsteinEffectCOVID19Vaccinations2023] Research drawing from the United States Census Bureau’s Household Pulse Survey, for example, has found that the secondary benefits of the protective effects of vaccination may include up to a 30% reduction in symptoms of anxiety and depression in vaccinated adults.[@agrawalImpactCOVID19Vaccine2021]

While this literature suggests that that receiving a COVID-19 vaccine can improve mental health state, the potential mental health benefits of public health announcements regarding the development of vaccines have received comparatively little attention. In the context of a deadly pandemic, the announcement of a novel safe and effective vaccine could be a powerful signal, providing a psychological boost and hope that the worst might soon be mitigated. Studying how population mental health may have been impacted by the release of vaccine efficacy and safety trial data may provide insights into how emotional well-being changed throughout the COVID-19 pandemic in response to these signals, which, in turn, could inform public health communication and contribute to our understanding of how the public processes and responds to information about vaccines—a necessary understanding for increasing vaccine uptake and trust in public health responses.

A key obstacle to studying the effects of public health responses on population mental health in the US, however, is a lack of daily surveillance data on mental health indicators; a potential marker of population mental health is the use of Internet search data, which offers the potential for real-time, large-scale analysis and identification of evolving mental health issues. A recently published evaluation of Google’s COVID-19 Search Trends Symptoms Dataset found strong correlation between search trends for depression and anxiety with indicators of mental health service utilization and need reported in the US Census Household Pulse Survey (HPS) with rates of emergency department visits for mental health condition as reported in the US Centers for Disease Control and Prevention’s (CDC) National Syndromic Surveillance Program (NSSP).[@vaidyanathanEvaluationInternetSearches2022] If taken as a reasonable proxy for mental health complaints, search data can provide valuable information on how population mental health reacts to real-time events and evolves over different shocks, enabling policymakers to better respond to mental health needs and assess reactions to public health efforts. 

Our study examines how news regarding the imminent availability of multiple safe and effective COVID-19 vaccines in November 2020 may have impacted population mental health even before these vaccines were made available to the public. Using Google search density data, we employed an interrupted time series approach to investigate how these announcements may have affected search trends for mental health symptoms in the United States and in five other countries. Owing to emerging evidence that political ideology may be a predictor of confidence in public health and vaccine hesitancy[@debusPoliticalIdeologyVaccination2021; @baumgaertnerInfluencePoliticalIdeology2018; @stolerSociopoliticalPsychologicalCorrelates2022] (with people identifying as conservative being more likely to express skepticism of public health authorities and the scientific community and being more likely to express concerns about the safety, effectiveness, or necessity of vaccines), we further explored whether changes in search trends for mental health symptoms varied across states and counties that predominantly voted Democrat versus Republic in the 2020 president election. Our findings suggest both immediate and sustained declines in search density for searches related to anxiety, depression, and major depressive disorder; these declines were observed both in the U.S. and abroad, and were found to be consistent irrespective of political ideology. 
